...
├── README.md                              # ← This file
├── LICENSE                                # GNU GPL v3.0 (full text below)
...
📖 Citation
If you use this framework, dataset, or results in your research, please cite:

bibtex
@misc{vivas2026ace,
  author    = {Vivas, Daniel},
  title     = {From Theory to Deep Space: Real-Data Validation of the AIKC Extension for IBI via NASA ACE Mission},
  year      = {2026},
  publisher = {Zenodo},
  doi       = {10.5281/zenodo.20085719},
  url       = {https://doi.org/10.5281/zenodo.20085719}
}
Additional References
bibtex
@misc{vivas2026ibi,
  author    = {Vivas, Daniel I. and Sanchez, J. and Brito, Y.},
  title     = {Effective Theory of Information-Based Instrumentation (IBI): Stochastic metrology for matter characterization through information physics},
  year      = {2026},
  publisher = {Zenodo},
  doi       = {10.5281/zenodo.19660069}
  url       = {https://doi.org/10.5281/zenodo. 19660069}
}

@article{smith2023ace,
  author    = {Smith, C. W. and ACE MFI Team},
  title     = {ACE Magnetic Field Instrument (MFI) Level 2 Data},
  year      = {2023},
  publisher = {NASA Space Physics Data Facility (SPDF)},
  url       = {https://spdf.gsfc.nasa.gov/pub/data/ace/mag/level_2_cdaweb/mfi_h2/}
}
👤 Author & Contact
•	Daniel I. Vivas Z.
Professor & Coordinator, Unidad Proyecto Aragua (UPA)
Faculty of Health Sciences (FCS), University of Carabobo, Venezuela
dvivas1@uc.edu.ve | vivaszdaniel@gmail.com 
